def adj_is_symbol(engine_schematic, i, rows, j, end_num, cols):
    # Check adjacent cells
    for di in range(max(i - 1, 0), min(i + 2, rows)):
        for dj in range(max(j - 1, 0), min(end_num + 2, cols)):
            if (
                not engine_schematic[di][dj].isdigit()
                and engine_schematic[di][dj] != "."
            ):
                return True
    return False


def calculate_part_sum(engine_schematic):
    ...
    for i in range(rows):
        ...
        while j < cols:
            ...
            if char.isdigit():
                end_num = j
                while engine_schematic[i][end_num].isdigit():
                    if end_num + 1 == cols:
                        break
                    elif not engine_schematic[i][end_num + 1].isdigit():
                        break
                    else:
                        end_num += 1

                if adj_is_symbol(engine_schematic, i, rows, j, end_num, cols):
                    print(engine_schematic[i][j : end_num + 1])
                    part_sum += int(engine_schematic[i][j : end_num + 1])
                j = end_num + 1
            j += 1
...
engine_schematic = """311...672...34...391.....591......828.......................738....................223....803..472..................................714.840.
...
..........56............822..................665............................563..383........................................................""".split(
    "\n"
)

# Calculate the sum of all part numbers in the engine schematic
result = calculate_part_sum(engine_schematic)

# Print the result
print("The sum of all part numbers in the engine schematic is:", result)
